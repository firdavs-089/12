// Loading animatsiyani yopish
        ...
        const galleryImages = [
            '/kinlar-lavhalar/vaqtlar aro sayohat -1.webp',
            '/kinlar-lavhalar/vaqtlar aro sayohat -12.webp',
            '/kinlar-lavhalar/vaqtlar aro sayohat -3.webp',
            '/kinlar-lavhalar/vaqtlar aro sayohat -4.webp'
        ];
        ...
        function showVideoPlayer(type) {
            ...
            if (type === 'movie') {
                video.src = 'https://fayllar1.ru/33/kinolar/Vaqtlar%20aro%20sayohatchi%202022%201080p%20(asilmedia.net).mp4';
            }
