// Loading animatsiyani yopish
        ...
        const galleryImages = [
            '/kinlar-lavhalar/opamning qasosi 1.jpg',
            '/kinlar-lavhalar/opamning qasosi 2.jpg',
            '/kinlar-lavhalar/opamning qasosi 3.jpg',
            '/kinlar-lavhalar/opamning qasosi 4.jpg'
        ];
        ...
        function showVideoPlayer(type) {
            ...
            if (type === 'movie') {
                video.src = 'https://fayllar1.ru/30/kinolar/Opamning%20qasosi%202016%201080p%20(asilmedia.net).mp4';
            }
