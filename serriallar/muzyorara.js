...
const episodeVideos = {
  1: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 1.mp4",
  2: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 2.mp4",
  3: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 3.mp4",
  4: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 4.mp4",
  5: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 5.mp4",
  6: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 6.mp4",
  7: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 7.mp4",
  8: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 8.mp4",
  9: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 9.mp4",
  10: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 10.mp4",
  11: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 11.mp4",
  12: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 12.mp4",
  13: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 13.mp4",
  14: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 14.mp4",
  15: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 15.mp4",
  16: "https://sifathd.com/Seriallar/E bolimi marvaridi/E Bo'limi Marvaridi 16.mp4",
}
...
const trailerTabBtn = document.getElementById("trailerTabBtn")
...
function selectEpisode(episodeNumber) {
  ...
  document.querySelector(`[data-episode="${episodeNumber}"]`).classList.add("active")

  // Update current episode title
  currentEpisodeTitle.textContent = `${episodeNumber}-qism`

  // Change video source
  const videoSource = episodeVideos[episodeNumber]
  if (videoSource) {
    mainVideo.src = videoSource
    mainVideo.load()
    showNotification(`${episodeNumber}-qism yuklandi`, "success")
  }
...
function updateEpisodeNavigation() {
  if (prevEpisodeBtn) {
    ...
    prevEpisodeBtn.style.opacity = currentEpisode <= 1 ? "0.5" : "1"
  }

  if (nextEpisodeBtn) {
    nextEpisodeBtn.disabled = currentEpisode >= totalEpisodes
    nextEpisodeBtn.style.opacity = currentEpisode >= totalEpisodes ? "0.5" : "1"
  }
}
...
// Tab Functions
function switchToEpisodesTab() {
  episodesTab.classList.add("active")
  trailerTabBtn.classList.remove("active")
  episodesGrid.style.display = "grid"
}

function switchToTrailerTab() {
  trailerTabBtn.classList.add("active")
...
function onVideoEnded() {
  ...
  if (currentEpisode < totalEpisodes) {
    ...
    showNotification("Keyingi qism 2 soniyada boshlanadi...", "info")
  } else {
    showNotification("Barcha qismlar tugadi", "info")
  }
}
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  // Episode tabs
  episodesTab.addEventListener("click", switchToEpisodesTab)
  trailerTabBtn.addEventListener("click", switchToTrailerTab)

  // Episode buttons
  document.querySelectorAll(".episode-btn").forEach((btn) => {
    btn.addEventListener("click", () => {
      const episodeNumber = Number.parseInt(btn.dataset.episode)
  ...
  if (prevEpisodeBtn) prevEpisodeBtn.addEventListener("click", goToPreviousEpisode)
  if (nextEpisodeBtn) nextEpisodeBtn.addEventListener("click", goToNextEpisode)
  ...
  telegramBtn.addEventListener("click", () => {
    window.open("https://t.me/aetherxfilm", "_blank")
  })
  ...
  document.querySelector(".instagram-btn").addEventListener("click", () => {
    window.open("https://instagram.com/aetherxfilm", "_blank")
  })
...
window.addEventListener("load", () => {
  console.log("Movie website with episodes loaded successfully!")
})
